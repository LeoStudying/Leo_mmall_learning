...
public class ProductManageController {
    ...
    @RequestMapping(value = "/save_or_update_product.do", method = RequestMethod.GET)
    @ResponseBody
    ...
    @ResponseBody
    public ServerResponse getProductList(HttpSession session, @RequestParam(value = "pageNumber" ,defaultValue = "1") Integer pageNumber,
    ...
    @ResponseBody
    public ServerResponse searchProduct(HttpSession session,Integer productId,
                                        String productName,
        ...
        if(iUserService.checkAdminRole(user).isSuccess()) {
            return iProductService.searchProduct(productId, productName, pageNumber, pageSize);
        } else {
            return ServerResponse.createByErrorMessage("您不是管理员，无权限操作");
        }
    }
